...
public class NewVisitorFragment extends Fragment {
    ...
    TextView in,out;
//    CardView cardMain1,cardMain2,cardMain3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_new_visitor, container, false);
...
//
        ...
        fragmentTransaction.add (R.id.new_visitor_frag, fragment,"in");

        //fragmentTransaction.addToBackStack(null);
//        fragmentTransaction.remove ( fragment);
//        fragmentTransaction.add (R.id.new_visitor_frag, fragment);
...
//                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
//                fragmentTransaction.replace (R.id.new_visitor_frag, fragment);
//                fragmentTransaction.addToBackStack(null);
//                in.setBackgroundDrawable(getResources().getDrawable(R.color.yellow));
//                out.setBackgroundDrawable(getResources().getDrawable(R.color.tabtext));
//                fragmentTransaction.commit ();
...
//        });
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().setTitle("New Visitor Entry");
                Fragment  fragment  = new NewVisitorRegistrationFragment();
                FragmentManager fragmentManager= getFragmentManager();
                FragmentTransaction fragmentTransaction = ((FragmentManager) fragmentManager).beginTransaction();
                fragmentTransaction.replace (R.id.bodyFrag, fragment,"new_visitor_entry");
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit ();
            }
        });
